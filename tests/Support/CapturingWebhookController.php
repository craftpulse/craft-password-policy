...
/**
 * Test subclass of the console `WebhookController` that captures
 * `stdout`/`stderr` into in-memory buffers instead of writing to the real
 * STDOUT/STDERR file descriptors.
 *
 * Mirrors {@see CapturingSiemController} — see {@see CapturingAuditController}
 ...
 * @since       5.2.0
 */
class CapturingWebhookController extends WebhookController
{
    // Public Properties
    // =========================================================================
