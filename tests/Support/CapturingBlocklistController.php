...
/**
 * Test subclass of the console `BlocklistController` that captures
 * `stdout`/`stderr` into in-memory buffers instead of writing to the
 ...
 * intercept. Tests that assert on emitted text subclass and override
 * both methods to append into capture properties — the production
 * controller path stays untouched.
 *
 ...
 * @since       5.2.0
 */
class CapturingBlocklistController extends BlocklistController
{
    // Public Properties
    // =========================================================================
