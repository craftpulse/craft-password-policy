...
- C — P1 backlog: **in progress**, P1.2 + P1.5 complete. 5 items remaining.
- D, E, F, G, H — pending.
...
In strict order. P1.7 is the smallest remaining win; do it first to unlock momentum.

### 1. P1.7 — `notificationLogRetentionDays` UI field (~20 min)
...
### 2. P1.4 + P1.3 — Notification CLI + email templates (paired, ~2 hours)
...
### 3. P1.11 — Custom dictionary EditableTable (Pro core, ~3 hours)
...
### 4. P1.8 — Deployment documentation (~1.5 hours)
